 ...
 * MIME helper class.
 *
 * Modified according to http://stackoverflow.com/a/6745788/1442004
 */
public final class MimeHelper {
    ...
    public static final String USER_AGENT_IE8 = "MSIE 8.0";
    ...
    private static boolean encode(String value, StringBuilder buf) {
        byte[] bytes;
        try {
     ...
     */
    protected static String encodeRFC2231(String value, String userAgent) {
        StringBuilder buf = new StringBuilder();
        if (StringUtils.hasText(userAgent) && userAgent.contains(USER_AGENT_IE8)) {
            encode(value, buf);
            return "; " + DISPOSITION_FILENAME + "=" + buf.toString();
        }
        ...
        if (encoded) {
            ...
            return "; " + DISPOSITION_FILENAME + "=" + value;
        }
    }
    ...
    public static String encodeContentDisposition(String filename, String userAgent) {
        return DISPOSITION_ATTACHMENT + encodeRFC2231(filename, userAgent);
    }
    ...
    public static byte[] getBoundaryFromMultiPart(String value) {
        try {
            ...
            if (multipartContentType == null
                    || !(multipartContentType.equalsIgnoreCase("multipart/form-data") || multipartContentType.equalsIgnoreCase("multipart/related"))) {
                return null;
            }
